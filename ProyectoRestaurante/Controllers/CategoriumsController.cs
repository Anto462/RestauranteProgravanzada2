...
namespace ProyectoRestaurante.Controllers
{
    public class CategoriumsController : Controller
    {
        ...
        public CategoriumsController(RestauranteContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categoria != null ? 
                          ...
                          Problem("Entity set 'RestauranteContext.Categoria'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCategoria,NombreCat")] Categorium categorium)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCategoria,NombreCat")] Categorium categorium)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'RestauranteContext.Categoria'  is null.");
            }
            var categorium = await _context.Categoria.FindAsync(id);
            if (categorium != null)
            {
